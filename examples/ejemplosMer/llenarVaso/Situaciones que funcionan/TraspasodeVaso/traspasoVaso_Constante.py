...
#  A UN VASO EN LA MISMA MESA. DESPUES EL VASO SE MUEVE A OTRA MESA     #
#  TODOS SON SIMBOLOS CONSTANTES.                                       #
#-----------------------------------------------------------------------#
...
def CheckTarget(graph):
	...
	if symbol_15.sType == 'Mesa'  and symbol_15.name != symbol_11.name and symbol_15.name != symbol_12.name and symbol_15.name != symbol_13.name and symbol_15.name != symbol_14.name: scoreNodes.append(100)
	...
	if [symbol_14.name, symbol_15.name,"en"] in graph.links: scoreLinks.append(100)
	if [symbol_14.name, symbol_15.name,"lleno"] in graph.links: scoreLinks.append(100)
