...
# Up to this point, all the code has been generated by the generateAGGLPlanerCode.py file
	...
	def getRules(self):
		...
		mapping['hierarchicalFindMilkInTable'] = self.hierarchicalFindMilkInTable
		mapping['hierarchicalFindMilkInTable_noReach'] = self.hierarchicalFindMilkInTable_noReach
		mapping['hierarchicalFindMugInTable'] = self.hierarchicalFindMugInTable
		mapping['hierarchicalFindMugInTable_noReach'] = self.hierarchicalFindMugInTable_noReach
		mapping['hierarchicalFindGlassesInTable'] = self.hierarchicalFindGlassesInTable
		mapping['hierarchicalFindGlassesInTable_noReach'] = self.hierarchicalFindGlassesInTable_noReach
		mapping['hierarchicalFindCoffeePotInTable'] = self.hierarchicalFindCoffeePotInTable
		mapping['hierarchicalFindCoffeePotInTable_noReach'] = self.hierarchicalFindCoffeePotInTable_noReach
		mapping['robotMovesObjectFromContainer'] = self.robotMovesObjectFromContainer
		mapping['robotDeliversObject'] = self.robotDeliversObject
		return mapping
	...
	def getTriggers(self):
		...
		mapping['hierarchicalFindMilkInTable'] = self.hierarchicalFindMilkInTable_trigger
		mapping['hierarchicalFindMilkInTable_noReach'] = self.hierarchicalFindMilkInTable_noReach_trigger
		mapping['hierarchicalFindMugInTable'] = self.hierarchicalFindMugInTable_trigger
		mapping['hierarchicalFindMugInTable_noReach'] = self.hierarchicalFindMugInTable_noReach_trigger
		mapping['hierarchicalFindGlassesInTable'] = self.hierarchicalFindGlassesInTable_trigger
		mapping['hierarchicalFindGlassesInTable_noReach'] = self.hierarchicalFindGlassesInTable_noReach_trigger
		mapping['hierarchicalFindCoffeePotInTable'] = self.hierarchicalFindCoffeePotInTable_trigger
		mapping['hierarchicalFindCoffeePotInTable_noReach'] = self.hierarchicalFindCoffeePotInTable_noReach_trigger
		mapping['robotMovesObjectFromContainer'] = self.robotMovesObjectFromContainer_trigger
		mapping['robotDeliversObject'] = self.robotDeliversObject_trigger
		return mapping

	def getHierarchicalTargets(self):
		mapping = dict()
		mapping['hierarchicalFindMilkInTable'] = self.hierarchicalFindMilkInTable_target
		mapping['hierarchicalFindMilkInTable_noReach'] = self.hierarchicalFindMilkInTable_noReach_target
		mapping['hierarchicalFindMugInTable'] = self.hierarchicalFindMugInTable_target
		mapping['hierarchicalFindMugInTable_noReach'] = self.hierarchicalFindMugInTable_noReach_target
		mapping['hierarchicalFindGlassesInTable'] = self.hierarchicalFindGlassesInTable_target
		mapping['hierarchicalFindGlassesInTable_noReach'] = self.hierarchicalFindGlassesInTable_noReach_target
		mapping['hierarchicalFindCoffeePotInTable'] = self.hierarchicalFindCoffeePotInTable_target
		mapping['hierarchicalFindCoffeePotInTable_noReach'] = self.hierarchicalFindCoffeePotInTable_noReach_target
		mapping['robotMovesObjectFromContainer'] = self.robotMovesObjectFromContainer_target
		mapping['robotDeliversObject'] = self.robotDeliversObject_target
		return mapping
	...
	# Rule hierarchicalFindMilkInTable
	def hierarchicalFindMilkInTable(self, snode, stackP=None, equivalencesP=None):
		if stackP == None: stackP=[]
		if equivalencesP == None: equivalencesP=[]
		stack        = copy.deepcopy(stackP)
		equivalences = copy.deepcopy(equivalencesP)
				...
				for symbol_robot_name in symbol_robot_nodes:
					...
					if symbol_robot.sType == 'robot' and symbol_robot.name!=symbol_container.name and [n2id["robot"],n2id["container"],"know"] in snode.graph.links:
						for symbol_room_name in symbol_room_nodes:
							symbol_room = nodes[symbol_room_name]
							n2id['room'] = symbol_room_name
							if symbol_room.sType == 'object' and symbol_room.name!=symbol_container.name and symbol_room.name!=symbol_robot.name and [n2id["robot"],n2id["room"],"in"] in snode.graph.links and [n2id["container"],n2id["room"],"in"] in snode.graph.links:
								for symbol_contst_name in symbol_contst_nodes:
									symbol_contst = nodes[symbol_contst_name]
									n2id['contst'] = symbol_contst_name
									if symbol_contst.sType == 'objectSt' and symbol_contst.name!=symbol_container.name and symbol_contst.name!=symbol_robot.name and symbol_contst.name!=symbol_room.name and [n2id["container"],n2id["contst"],"table"] in snode.graph.links and not [n2id["container"],n2id["contst"],"explored"] in snode.graph.links:
										...
										stack2        = copy.deepcopy(stack)
										equivalences2 = copy.deepcopy(equivalences)
										r1 = self.hierarchicalFindMilkInTable_trigger(snode, n2id, stack2, inCombo, equivalences2, copy.deepcopy(finishesCombo))
										c = copy.deepcopy(r1)
										if 'fina' in locals():
											c.history.append(finishesCombo)
										if len(stack2) > 0: c.stop = True
	...
	# Rule hierarchicalFindMilkInTable
	def hierarchicalFindMilkInTable_trigger(self, snode, n2id, stack=None, inCombo=False, equivalences=None, checked=True, finish='', verbose=False):
		if stack == None: stack=[]
		if equivalences == None: equivalences=[]
		if not checked:
			test_symbol_container = snode.graph.nodes[n2id['container']]
			if not (test_symbol_container.sType == 'object'):
				if verbose: print 'test_symbol_container(',n2id['container'],').sType == object' , test_symbol_container.sType == 'object'
				raise WrongRuleExecution('hierarchicalFindMilkInTable_trigger1')
			test_symbol_robot = snode.graph.nodes[n2id['robot']]
			if not (test_symbol_robot.sType == 'robot' and test_symbol_robot.name!=test_symbol_container.name and [n2id["robot"],n2id["container"],"know"] in snode.graph.links):
				if verbose: print 'test_symbol_robot(',n2id['robot'],').sType == robot' , test_symbol_robot.sType == 'robot'
				raise WrongRuleExecution('hierarchicalFindMilkInTable_trigger2')
			test_symbol_room = snode.graph.nodes[n2id['room']]
			if not (test_symbol_room.sType == 'object' and test_symbol_room.name!=test_symbol_container.name and test_symbol_room.name!=test_symbol_robot.name and [n2id["robot"],n2id["room"],"in"] in snode.graph.links and [n2id["container"],n2id["room"],"in"] in snode.graph.links):
				if verbose: print 'test_symbol_room(',n2id['room'],').sType == object' , test_symbol_room.sType == 'object'
		...
		lastNodeId += 1
		newNode.nodeId = lastNodeId
		newNode.parentNodeToExplore = copy.deepcopy(snode)
		newNode.parentNodeToExploreWith = self.hierarchicalFindMilkInTable
		newNode.stackP = copy.deepcopy(stack)
		newNode.equivalencesP = copy.deepcopy(equivalences)
		# Create nodes
		if not 'status' in n2id:
			newName = str(getNewIdForSymbol(newNode))
			n2id['status'] = newName
		...
		if not l in newNode.graph.links:
			newNode.graph.links.append(l)
		l = AGMLink(n2id['object'], n2id['status'], 'milk')
		if not l in newNode.graph.links:
			newNode.graph.links.append(l)
		l = AGMLink(n2id['object'], n2id['status'], 'reach')
		if not l in newNode.graph.links:
		...
		if not inCombo:
			newNode.cost += 1
			newNode.depth += 1
		newNode.history.append('*hierarchicalFindMilkInTable@' + str(n2id) )
		if finish!='': newNode.history.append(finish)
		return newNode
		
		

	def hierarchicalFindMilkInTable_target(self, graph, smapping=dict()):
		n2id = copy.deepcopy(smapping)

		available = copy.deepcopy(graph.nodes)
		maxScore = 0
		totalScore = 2000

		del available[n2id['container']]
		del available[n2id['room']]
		del available[n2id['contst']]
		del available[n2id['robot']]
		# Hard score
		scoreNodes = []
		scoreLinks = []
		# container
		symbol_container = graph.nodes[n2id['container']]
		linksVal = 0
		...
		if symbol_container.sType == 'object':
			...
			maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
			# room
			symbol_room = graph.nodes[n2id['room']]
			linksVal = 0
			if [n2id["container"],n2id["room"],"in"]  in graph.links: linksVal += 100
			scoreLinks.append(linksVal)
			maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
			if symbol_room.sType == 'object' and symbol_room.name!=symbol_container.name and [n2id["container"],n2id["room"],"in"] in graph.links:
				scoreNodes.append(100)
				maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
				# contst
				...
				if symbol_contst.sType == 'objectSt' and symbol_contst.name!=symbol_container.name and symbol_contst.name!=symbol_room.name and [n2id["container"],n2id["contst"],"table"] in graph.links and not [n2id["container"],n2id["contst"],"explored"] in graph.links:
					...
					maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
					# robot
					symbol_robot = graph.nodes[n2id['robot']]
					linksVal = 0
					if [n2id["robot"],n2id["container"],"know"]  in graph.links: linksVal += 100
					if [n2id["robot"],n2id["room"],"in"]  in graph.links: linksVal += 100
					scoreLinks.append(linksVal)
					maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
					if symbol_robot.sType == 'robot' and symbol_robot.name!=symbol_container.name and symbol_robot.name!=symbol_room.name and symbol_robot.name!=symbol_contst.name and [n2id["robot"],n2id["container"],"know"] in graph.links and [n2id["robot"],n2id["room"],"in"] in graph.links:
						scoreNodes.append(100)
						maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
						# status
						...
						for symbol_status_name in available:
							...
							scoreLinks.append(linksVal)
							maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
							if symbol_status.sType == 'objectSt' and symbol_status.name!=symbol_container.name and symbol_status.name!=symbol_room.name and symbol_status.name!=symbol_contst.name and symbol_status.name!=symbol_robot.name:
								scoreNodes.append(100)
								maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
								# object
								...
								for symbol_object_name in available:
									...
									n2id['object'] = symbol_object_name
									linksVal = 0
									if [n2id["robot"],n2id["object"],"know"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["status"],"see"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["status"],"classified"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["status"],"milk"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["status"],"reach"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["status"],"position"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["status"],"reachable"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["status"],"hasStatus"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["container"],"in"]  in graph.links: linksVal += 100
									scoreLinks.append(linksVal)
									maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
									if symbol_object.sType == 'object' and symbol_object.name!=symbol_container.name and symbol_object.name!=symbol_room.name and symbol_object.name!=symbol_contst.name and symbol_object.name!=symbol_robot.name and symbol_object.name!=symbol_status.name and [n2id["robot"],n2id["object"],"know"] in graph.links and [n2id["object"],n2id["status"],"see"] in graph.links and [n2id["object"],n2id["status"],"classified"] in graph.links and [n2id["object"],n2id["status"],"milk"] in graph.links and [n2id["object"],n2id["status"],"reach"] in graph.links and [n2id["object"],n2id["status"],"position"] in graph.links and [n2id["object"],n2id["status"],"reachable"] in graph.links and [n2id["object"],n2id["status"],"hasStatus"] in graph.links and [n2id["object"],n2id["container"],"in"] in graph.links:
										scoreNodes.append(100)
										maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
										if maxScore == 2000:
	...
	# Rule hierarchicalFindMilkInTable_noReach
	def hierarchicalFindMilkInTable_noReach(self, snode, stackP=None, equivalencesP=None):
		if stackP == None: stackP=[]
		if equivalencesP == None: equivalencesP=[]
		stack        = copy.deepcopy(stackP)
		equivalences = copy.deepcopy(equivalencesP)
							...
							if symbol_room.sType == 'object' and symbol_room.name!=symbol_container.name and symbol_room.name!=symbol_robot.name and [n2id["robot"],n2id["room"],"in"] in snode.graph.links and [n2id["container"],n2id["room"],"in"] in snode.graph.links:
								for symbol_contst_name in symbol_contst_nodes:
									...
									if symbol_contst.sType == 'objectSt' and symbol_contst.name!=symbol_container.name and symbol_contst.name!=symbol_robot.name and symbol_contst.name!=symbol_room.name and [n2id["container"],n2id["contst"],"table"] in snode.graph.links and not [n2id["container"],n2id["contst"],"explored"] in snode.graph.links:
										...
										stack2        = copy.deepcopy(stack)
										equivalences2 = copy.deepcopy(equivalences)
										r1 = self.hierarchicalFindMilkInTable_noReach_trigger(snode, n2id, stack2, inCombo, equivalences2, copy.deepcopy(finishesCombo))
										c = copy.deepcopy(r1)
										if 'fina' in locals():
											c.history.append(finishesCombo)
										if len(stack2) > 0: c.stop = True
	...
	# Rule hierarchicalFindMilkInTable_noReach
	def hierarchicalFindMilkInTable_noReach_trigger(self, snode, n2id, stack=None, inCombo=False, equivalences=None, checked=True, finish='', verbose=False):
		if stack == None: stack=[]
		if equivalences == None: equivalences=[]
		if not checked:
			test_symbol_container = snode.graph.nodes[n2id['container']]
			if not (test_symbol_container.sType == 'object'):
				if verbose: print 'test_symbol_container(',n2id['container'],').sType == object' , test_symbol_container.sType == 'object'
				raise WrongRuleExecution('hierarchicalFindMilkInTable_noReach_trigger1')
			test_symbol_robot = snode.graph.nodes[n2id['robot']]
			if not (test_symbol_robot.sType == 'robot' and test_symbol_robot.name!=test_symbol_container.name and [n2id["robot"],n2id["container"],"know"] in snode.graph.links):
				if verbose: print 'test_symbol_robot(',n2id['robot'],').sType == robot' , test_symbol_robot.sType == 'robot'
				raise WrongRuleExecution('hierarchicalFindMilkInTable_noReach_trigger2')
			test_symbol_room = snode.graph.nodes[n2id['room']]
			if not (test_symbol_room.sType == 'object' and test_symbol_room.name!=test_symbol_container.name and test_symbol_room.name!=test_symbol_robot.name and [n2id["robot"],n2id["room"],"in"] in snode.graph.links and [n2id["container"],n2id["room"],"in"] in snode.graph.links):
				if verbose: print 'test_symbol_room(',n2id['room'],').sType == object' , test_symbol_room.sType == 'object'
		...
		newNode.nodeId = lastNodeId
		newNode.parentNodeToExplore = copy.deepcopy(snode)
		newNode.parentNodeToExploreWith = self.hierarchicalFindMilkInTable_noReach
		newNode.stackP = copy.deepcopy(stack)
		newNode.equivalencesP = copy.deepcopy(equivalences)
		# Create nodes
		if not 'status' in n2id:
		...
		if not inCombo:
			newNode.cost += 1
			newNode.depth += 1
		newNode.history.append('*hierarchicalFindMilkInTable_noReach@' + str(n2id) )
		if finish!='': newNode.history.append(finish)
		return newNode
		
		

	def hierarchicalFindMilkInTable_noReach_target(self, graph, smapping=dict()):
		n2id = copy.deepcopy(smapping)
						...
						for symbol_status_name in available:
							...
							if symbol_status.sType == 'objectSt' and symbol_status.name!=symbol_container.name and symbol_status.name!=symbol_room.name and symbol_status.name!=symbol_contst.name and symbol_status.name!=symbol_robot.name:
								...
								for symbol_object_name in available:
									...
									if [n2id["object"],n2id["status"],"classified"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["status"],"milk"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["status"],"noReach"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["status"],"position"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["status"],"reachable"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["status"],"hasStatus"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["container"],"in"]  in graph.links: linksVal += 100
									scoreLinks.append(linksVal)
									maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
									if symbol_object.sType == 'object' and symbol_object.name!=symbol_container.name and symbol_object.name!=symbol_room.name and symbol_object.name!=symbol_contst.name and symbol_object.name!=symbol_robot.name and symbol_object.name!=symbol_status.name and [n2id["robot"],n2id["object"],"know"] in graph.links and [n2id["object"],n2id["status"],"see"] in graph.links and [n2id["object"],n2id["status"],"classified"] in graph.links and [n2id["object"],n2id["status"],"milk"] in graph.links and [n2id["object"],n2id["status"],"noReach"] in graph.links and [n2id["object"],n2id["status"],"position"] in graph.links and [n2id["object"],n2id["status"],"reachable"] in graph.links and [n2id["object"],n2id["status"],"hasStatus"] in graph.links and [n2id["object"],n2id["container"],"in"] in graph.links:
										scoreNodes.append(100)
										maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
										if maxScore == 2000:
											return maxScore, True
	...
	# Rule hierarchicalFindMugInTable
	def hierarchicalFindMugInTable(self, snode, stackP=None, equivalencesP=None):
		if stackP == None: stackP=[]
		if equivalencesP == None: equivalencesP=[]
		stack        = copy.deepcopy(stackP)
		equivalences = copy.deepcopy(equivalencesP)
							...
							if symbol_room.sType == 'object' and symbol_room.name!=symbol_container.name and symbol_room.name!=symbol_robot.name and [n2id["robot"],n2id["room"],"in"] in snode.graph.links and [n2id["container"],n2id["room"],"in"] in snode.graph.links:
								for symbol_contst_name in symbol_contst_nodes:
									...
									if symbol_contst.sType == 'objectSt' and symbol_contst.name!=symbol_container.name and symbol_contst.name!=symbol_robot.name and symbol_contst.name!=symbol_room.name and not [n2id["container"],n2id["contst"],"explored"] in snode.graph.links and [n2id["container"],n2id["contst"],"table"] in snode.graph.links:
										...
										stack2        = copy.deepcopy(stack)
										equivalences2 = copy.deepcopy(equivalences)
										r1 = self.hierarchicalFindMugInTable_trigger(snode, n2id, stack2, inCombo, equivalences2, copy.deepcopy(finishesCombo))
										c = copy.deepcopy(r1)
										if 'fina' in locals():
											c.history.append(finishesCombo)
										if len(stack2) > 0: c.stop = True
	...
	# Rule hierarchicalFindMugInTable
	def hierarchicalFindMugInTable_trigger(self, snode, n2id, stack=None, inCombo=False, equivalences=None, checked=True, finish='', verbose=False):
		if stack == None: stack=[]
		if equivalences == None: equivalences=[]
		if not checked:
			test_symbol_container = snode.graph.nodes[n2id['container']]
			if not (test_symbol_container.sType == 'object'):
				if verbose: print 'test_symbol_container(',n2id['container'],').sType == object' , test_symbol_container.sType == 'object'
				raise WrongRuleExecution('hierarchicalFindMugInTable_trigger1')
			test_symbol_robot = snode.graph.nodes[n2id['robot']]
			if not (test_symbol_robot.sType == 'robot' and test_symbol_robot.name!=test_symbol_container.name and [n2id["robot"],n2id["container"],"know"] in snode.graph.links):
				if verbose: print 'test_symbol_robot(',n2id['robot'],').sType == robot' , test_symbol_robot.sType == 'robot'
				raise WrongRuleExecution('hierarchicalFindMugInTable_trigger2')
			test_symbol_room = snode.graph.nodes[n2id['room']]
			if not (test_symbol_room.sType == 'object' and test_symbol_room.name!=test_symbol_container.name and test_symbol_room.name!=test_symbol_robot.name and [n2id["robot"],n2id["room"],"in"] in snode.graph.links and [n2id["container"],n2id["room"],"in"] in snode.graph.links):
				if verbose: print 'test_symbol_room(',n2id['room'],').sType == object' , test_symbol_room.sType == 'object'
		...
		newNode.nodeId = lastNodeId
		newNode.parentNodeToExplore = copy.deepcopy(snode)
		newNode.parentNodeToExploreWith = self.hierarchicalFindMugInTable
		newNode.stackP = copy.deepcopy(stack)
		newNode.equivalencesP = copy.deepcopy(equivalences)
		# Create nodes
		if not 'status' in n2id:
		...
		# Remove links
		# Create links
		l = AGMLink(n2id['container'], n2id['contst'], 'reach')
		if not l in newNode.graph.links:
			newNode.graph.links.append(l)
		l = AGMLink(n2id['robot'], n2id['object'], 'know')
		if not l in newNode.graph.links:
		...
		if not inCombo:
			newNode.cost += 1
			newNode.depth += 1
		newNode.history.append('*hierarchicalFindMugInTable@' + str(n2id) )
		if finish!='': newNode.history.append(finish)
		return newNode
		
		

	def hierarchicalFindMugInTable_target(self, graph, smapping=dict()):
		n2id = copy.deepcopy(smapping)
						...
						for symbol_status_name in available:
							...
							if symbol_status.sType == 'objectSt' and symbol_status.name!=symbol_container.name and symbol_status.name!=symbol_room.name and symbol_status.name!=symbol_contst.name and symbol_status.name!=symbol_robot.name:
								...
								for symbol_object_name in available:
									...
									scoreLinks.append(linksVal)
									maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
									if symbol_object.sType == 'object' and symbol_object.name!=symbol_container.name and symbol_object.name!=symbol_room.name and symbol_object.name!=symbol_contst.name and symbol_object.name!=symbol_robot.name and symbol_object.name!=symbol_status.name and [n2id["robot"],n2id["object"],"know"] in graph.links and [n2id["object"],n2id["status"],"see"] in graph.links and [n2id["object"],n2id["status"],"classified"] in graph.links and [n2id["object"],n2id["status"],"mug"] in graph.links and [n2id["object"],n2id["status"],"reach"] in graph.links and [n2id["object"],n2id["status"],"position"] in graph.links and [n2id["object"],n2id["status"],"reachable"] in graph.links and [n2id["object"],n2id["status"],"hasStatus"] in graph.links and [n2id["object"],n2id["container"],"in"] in graph.links:
										scoreNodes.append(100)
										maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
										if maxScore == 2100:
											return maxScore, True
	...
	# Rule hierarchicalFindMugInTable_noReach
	def hierarchicalFindMugInTable_noReach(self, snode, stackP=None, equivalencesP=None):
		if stackP == None: stackP=[]
		if equivalencesP == None: equivalencesP=[]
		stack        = copy.deepcopy(stackP)
		equivalences = copy.deepcopy(equivalencesP)
							...
							if symbol_contst.sType == 'objectSt' and symbol_contst.name!=symbol_container.name and symbol_contst.name!=symbol_robot.name and not [n2id["container"],n2id["contst"],"explored"] in snode.graph.links and [n2id["container"],n2id["contst"],"table"] in snode.graph.links and [n2id["container"],n2id["contst"],"reach"] in snode.graph.links:
								for symbol_room_name in symbol_room_nodes:
									...
									if symbol_room.sType == 'object' and symbol_room.name!=symbol_container.name and symbol_room.name!=symbol_robot.name and symbol_room.name!=symbol_contst.name and [n2id["robot"],n2id["room"],"in"] in snode.graph.links and [n2id["container"],n2id["room"],"in"] in snode.graph.links:
										...
										stack2        = copy.deepcopy(stack)
										equivalences2 = copy.deepcopy(equivalences)
										r1 = self.hierarchicalFindMugInTable_noReach_trigger(snode, n2id, stack2, inCombo, equivalences2, copy.deepcopy(finishesCombo))
										c = copy.deepcopy(r1)
										if 'fina' in locals():
											c.history.append(finishesCombo)
										if len(stack2) > 0: c.stop = True
	...
	# Rule hierarchicalFindMugInTable_noReach
	def hierarchicalFindMugInTable_noReach_trigger(self, snode, n2id, stack=None, inCombo=False, equivalences=None, checked=True, finish='', verbose=False):
		if stack == None: stack=[]
		if equivalences == None: equivalences=[]
		if not checked:
			test_symbol_container = snode.graph.nodes[n2id['container']]
			if not (test_symbol_container.sType == 'object'):
				if verbose: print 'test_symbol_container(',n2id['container'],').sType == object' , test_symbol_container.sType == 'object'
				raise WrongRuleExecution('hierarchicalFindMugInTable_noReach_trigger1')
			test_symbol_robot = snode.graph.nodes[n2id['robot']]
			if not (test_symbol_robot.sType == 'robot' and test_symbol_robot.name!=test_symbol_container.name and [n2id["robot"],n2id["container"],"know"] in snode.graph.links):
				if verbose: print 'test_symbol_robot(',n2id['robot'],').sType == robot' , test_symbol_robot.sType == 'robot'
			...
			if not (test_symbol_room.sType == 'object' and test_symbol_room.name!=test_symbol_container.name and test_symbol_room.name!=test_symbol_robot.name and test_symbol_room.name!=test_symbol_contst.name and [n2id["robot"],n2id["room"],"in"] in snode.graph.links and [n2id["container"],n2id["room"],"in"] in snode.graph.links):
				if verbose: print 'test_symbol_room(',n2id['room'],').sType == object' , test_symbol_room.sType == 'object'
				raise WrongRuleExecution('hierarchicalFindMugInTable_noReach_trigger4')
		newNode = WorldStateHistory(snode)
		global lastNodeId
		lastNodeId += 1
		newNode.nodeId = lastNodeId
		newNode.parentNodeToExplore = copy.deepcopy(snode)
		newNode.parentNodeToExploreWith = self.hierarchicalFindMugInTable_noReach
		newNode.stackP = copy.deepcopy(stack)
		newNode.equivalencesP = copy.deepcopy(equivalences)
		# Create nodes
		if not 'status' in n2id:
		...
		if not inCombo:
			newNode.cost += 1
			newNode.depth += 1
		newNode.history.append('*hierarchicalFindMugInTable_noReach@' + str(n2id) )
		if finish!='': newNode.history.append(finish)
		return newNode
		
		

	def hierarchicalFindMugInTable_noReach_target(self, graph, smapping=dict()):
		n2id = copy.deepcopy(smapping)
						...
						for symbol_status_name in available:
							...
							if symbol_status.sType == 'objectSt' and symbol_status.name!=symbol_container.name and symbol_status.name!=symbol_room.name and symbol_status.name!=symbol_contst.name and symbol_status.name!=symbol_robot.name:
								...
								for symbol_object_name in available:
									...
									scoreLinks.append(linksVal)
									maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
									if symbol_object.sType == 'object' and symbol_object.name!=symbol_container.name and symbol_object.name!=symbol_room.name and symbol_object.name!=symbol_contst.name and symbol_object.name!=symbol_robot.name and symbol_object.name!=symbol_status.name and [n2id["robot"],n2id["object"],"know"] in graph.links and [n2id["object"],n2id["status"],"see"] in graph.links and [n2id["object"],n2id["status"],"classified"] in graph.links and [n2id["object"],n2id["status"],"mug"] in graph.links and [n2id["object"],n2id["status"],"noReach"] in graph.links and [n2id["object"],n2id["status"],"position"] in graph.links and [n2id["object"],n2id["status"],"reachable"] in graph.links and [n2id["object"],n2id["status"],"hasStatus"] in graph.links and [n2id["object"],n2id["container"],"in"] in graph.links:
										scoreNodes.append(100)
										maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
										if maxScore == 2100:
											return maxScore, True
	...
	# Rule hierarchicalFindGlassesInTable
	def hierarchicalFindGlassesInTable(self, snode, stackP=None, equivalencesP=None):
		if stackP == None: stackP=[]
		if equivalencesP == None: equivalencesP=[]
		stack        = copy.deepcopy(stackP)
		equivalences = copy.deepcopy(equivalencesP)
							...
							if symbol_room.sType == 'object' and symbol_room.name!=symbol_container.name and symbol_room.name!=symbol_robot.name and [n2id["robot"],n2id["room"],"in"] in snode.graph.links and [n2id["container"],n2id["room"],"in"] in snode.graph.links:
								for symbol_contst_name in symbol_contst_nodes:
									...
									if symbol_contst.sType == 'objectSt' and symbol_contst.name!=symbol_container.name and symbol_contst.name!=symbol_robot.name and symbol_contst.name!=symbol_room.name and not [n2id["container"],n2id["contst"],"explored"] in snode.graph.links and [n2id["container"],n2id["contst"],"table"] in snode.graph.links:
										...
										stack2        = copy.deepcopy(stack)
										equivalences2 = copy.deepcopy(equivalences)
										r1 = self.hierarchicalFindGlassesInTable_trigger(snode, n2id, stack2, inCombo, equivalences2, copy.deepcopy(finishesCombo))
										c = copy.deepcopy(r1)
										if 'fina' in locals():
											c.history.append(finishesCombo)
										if len(stack2) > 0: c.stop = True
	...
	# Rule hierarchicalFindGlassesInTable
	def hierarchicalFindGlassesInTable_trigger(self, snode, n2id, stack=None, inCombo=False, equivalences=None, checked=True, finish='', verbose=False):
		if stack == None: stack=[]
		if equivalences == None: equivalences=[]
		if not checked:
			test_symbol_container = snode.graph.nodes[n2id['container']]
			if not (test_symbol_container.sType == 'object'):
				if verbose: print 'test_symbol_container(',n2id['container'],').sType == object' , test_symbol_container.sType == 'object'
				raise WrongRuleExecution('hierarchicalFindGlassesInTable_trigger1')
			test_symbol_robot = snode.graph.nodes[n2id['robot']]
			if not (test_symbol_robot.sType == 'robot' and test_symbol_robot.name!=test_symbol_container.name and [n2id["robot"],n2id["container"],"know"] in snode.graph.links):
				if verbose: print 'test_symbol_robot(',n2id['robot'],').sType == robot' , test_symbol_robot.sType == 'robot'
				raise WrongRuleExecution('hierarchicalFindGlassesInTable_trigger2')
			test_symbol_room = snode.graph.nodes[n2id['room']]
			if not (test_symbol_room.sType == 'object' and test_symbol_room.name!=test_symbol_container.name and test_symbol_room.name!=test_symbol_robot.name and [n2id["robot"],n2id["room"],"in"] in snode.graph.links and [n2id["container"],n2id["room"],"in"] in snode.graph.links):
				if verbose: print 'test_symbol_room(',n2id['room'],').sType == object' , test_symbol_room.sType == 'object'
		...
		newNode.nodeId = lastNodeId
		newNode.parentNodeToExplore = copy.deepcopy(snode)
		newNode.parentNodeToExploreWith = self.hierarchicalFindGlassesInTable
		newNode.stackP = copy.deepcopy(stack)
		newNode.equivalencesP = copy.deepcopy(equivalences)
		# Create nodes
		if not 'status' in n2id:
		...
		if not inCombo:
			newNode.cost += 1
			newNode.depth += 1
		newNode.history.append('*hierarchicalFindGlassesInTable@' + str(n2id) )
		if finish!='': newNode.history.append(finish)
		return newNode
		
		

	def hierarchicalFindGlassesInTable_target(self, graph, smapping=dict()):
		n2id = copy.deepcopy(smapping)
						...
						for symbol_status_name in available:
							...
							if symbol_status.sType == 'objectSt' and symbol_status.name!=symbol_container.name and symbol_status.name!=symbol_room.name and symbol_status.name!=symbol_contst.name and symbol_status.name!=symbol_robot.name:
								...
								for symbol_object_name in available:
									...
									if [n2id["object"],n2id["status"],"see"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["status"],"classified"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["status"],"glasses"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["status"],"reach"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["status"],"position"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["status"],"reachable"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["status"],"hasStatus"]  in graph.links: linksVal += 100
									...
									scoreLinks.append(linksVal)
									maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
									if symbol_object.sType == 'object' and symbol_object.name!=symbol_container.name and symbol_object.name!=symbol_room.name and symbol_object.name!=symbol_contst.name and symbol_object.name!=symbol_robot.name and symbol_object.name!=symbol_status.name and [n2id["robot"],n2id["object"],"know"] in graph.links and [n2id["object"],n2id["status"],"see"] in graph.links and [n2id["object"],n2id["status"],"classified"] in graph.links and [n2id["object"],n2id["status"],"glasses"] in graph.links and [n2id["object"],n2id["status"],"reach"] in graph.links and [n2id["object"],n2id["status"],"position"] in graph.links and [n2id["object"],n2id["status"],"reachable"] in graph.links and [n2id["object"],n2id["status"],"hasStatus"] in graph.links and [n2id["object"],n2id["container"],"in"] in graph.links:
										scoreNodes.append(100)
										maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
										if maxScore == 2000:
											return maxScore, True
	...
	# Rule hierarchicalFindGlassesInTable_noReach
	def hierarchicalFindGlassesInTable_noReach(self, snode, stackP=None, equivalencesP=None):
		if stackP == None: stackP=[]
		if equivalencesP == None: equivalencesP=[]
		stack        = copy.deepcopy(stackP)
		equivalences = copy.deepcopy(equivalencesP)
							...
							if symbol_room.sType == 'object' and symbol_room.name!=symbol_container.name and symbol_room.name!=symbol_robot.name and [n2id["robot"],n2id["room"],"in"] in snode.graph.links and [n2id["container"],n2id["room"],"in"] in snode.graph.links:
								for symbol_contst_name in symbol_contst_nodes:
									...
									if symbol_contst.sType == 'objectSt' and symbol_contst.name!=symbol_container.name and symbol_contst.name!=symbol_robot.name and symbol_contst.name!=symbol_room.name and not [n2id["container"],n2id["contst"],"explored"] in snode.graph.links and [n2id["container"],n2id["contst"],"table"] in snode.graph.links:
										...
										stack2        = copy.deepcopy(stack)
										equivalences2 = copy.deepcopy(equivalences)
										r1 = self.hierarchicalFindGlassesInTable_noReach_trigger(snode, n2id, stack2, inCombo, equivalences2, copy.deepcopy(finishesCombo))
										c = copy.deepcopy(r1)
										if 'fina' in locals():
											c.history.append(finishesCombo)
										if len(stack2) > 0: c.stop = True
	...
	# Rule hierarchicalFindGlassesInTable_noReach
	def hierarchicalFindGlassesInTable_noReach_trigger(self, snode, n2id, stack=None, inCombo=False, equivalences=None, checked=True, finish='', verbose=False):
		if stack == None: stack=[]
		if equivalences == None: equivalences=[]
		if not checked:
			test_symbol_container = snode.graph.nodes[n2id['container']]
			if not (test_symbol_container.sType == 'object'):
				if verbose: print 'test_symbol_container(',n2id['container'],').sType == object' , test_symbol_container.sType == 'object'
				raise WrongRuleExecution('hierarchicalFindGlassesInTable_noReach_trigger1')
			test_symbol_robot = snode.graph.nodes[n2id['robot']]
			if not (test_symbol_robot.sType == 'robot' and test_symbol_robot.name!=test_symbol_container.name and [n2id["robot"],n2id["container"],"know"] in snode.graph.links):
				if verbose: print 'test_symbol_robot(',n2id['robot'],').sType == robot' , test_symbol_robot.sType == 'robot'
				raise WrongRuleExecution('hierarchicalFindGlassesInTable_noReach_trigger2')
			test_symbol_room = snode.graph.nodes[n2id['room']]
			if not (test_symbol_room.sType == 'object' and test_symbol_room.name!=test_symbol_container.name and test_symbol_room.name!=test_symbol_robot.name and [n2id["robot"],n2id["room"],"in"] in snode.graph.links and [n2id["container"],n2id["room"],"in"] in snode.graph.links):
				if verbose: print 'test_symbol_room(',n2id['room'],').sType == object' , test_symbol_room.sType == 'object'
		...
		newNode.nodeId = lastNodeId
		newNode.parentNodeToExplore = copy.deepcopy(snode)
		newNode.parentNodeToExploreWith = self.hierarchicalFindGlassesInTable_noReach
		newNode.stackP = copy.deepcopy(stack)
		newNode.equivalencesP = copy.deepcopy(equivalences)
		# Create nodes
		if not 'status' in n2id:
		...
		if not inCombo:
			newNode.cost += 1
			newNode.depth += 1
		newNode.history.append('*hierarchicalFindGlassesInTable_noReach@' + str(n2id) )
		if finish!='': newNode.history.append(finish)
		return newNode
		
		

	def hierarchicalFindGlassesInTable_noReach_target(self, graph, smapping=dict()):
		n2id = copy.deepcopy(smapping)
						...
						for symbol_status_name in available:
							...
							if symbol_status.sType == 'objectSt' and symbol_status.name!=symbol_container.name and symbol_status.name!=symbol_room.name and symbol_status.name!=symbol_contst.name and symbol_status.name!=symbol_robot.name:
								...
								for symbol_object_name in available:
									...
									scoreLinks.append(linksVal)
									maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
									if symbol_object.sType == 'object' and symbol_object.name!=symbol_container.name and symbol_object.name!=symbol_room.name and symbol_object.name!=symbol_contst.name and symbol_object.name!=symbol_robot.name and symbol_object.name!=symbol_status.name and [n2id["robot"],n2id["object"],"know"] in graph.links and [n2id["object"],n2id["status"],"see"] in graph.links and [n2id["object"],n2id["status"],"classified"] in graph.links and [n2id["object"],n2id["status"],"glasses"] in graph.links and [n2id["object"],n2id["status"],"noReach"] in graph.links and [n2id["object"],n2id["status"],"position"] in graph.links and [n2id["object"],n2id["status"],"reachable"] in graph.links and [n2id["object"],n2id["status"],"hasStatus"] in graph.links and [n2id["object"],n2id["container"],"in"] in graph.links:
										scoreNodes.append(100)
										maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
										if maxScore == 2000:
											return maxScore, True
	...
	# Rule hierarchicalFindCoffeePotInTable
	def hierarchicalFindCoffeePotInTable(self, snode, stackP=None, equivalencesP=None):
		if stackP == None: stackP=[]
		if equivalencesP == None: equivalencesP=[]
		stack        = copy.deepcopy(stackP)
		equivalences = copy.deepcopy(equivalencesP)
							...
							if symbol_room.sType == 'object' and symbol_room.name!=symbol_container.name and symbol_room.name!=symbol_robot.name and [n2id["robot"],n2id["room"],"in"] in snode.graph.links and [n2id["container"],n2id["room"],"in"] in snode.graph.links:
								for symbol_contst_name in symbol_contst_nodes:
									...
									if symbol_contst.sType == 'objectSt' and symbol_contst.name!=symbol_container.name and symbol_contst.name!=symbol_robot.name and symbol_contst.name!=symbol_room.name and [n2id["container"],n2id["contst"],"table"] in snode.graph.links and not [n2id["container"],n2id["contst"],"explored"] in snode.graph.links:
										...
										stack2        = copy.deepcopy(stack)
										equivalences2 = copy.deepcopy(equivalences)
										r1 = self.hierarchicalFindCoffeePotInTable_trigger(snode, n2id, stack2, inCombo, equivalences2, copy.deepcopy(finishesCombo))
										c = copy.deepcopy(r1)
										if 'fina' in locals():
											c.history.append(finishesCombo)
										if len(stack2) > 0: c.stop = True
	...
	# Rule hierarchicalFindCoffeePotInTable
	def hierarchicalFindCoffeePotInTable_trigger(self, snode, n2id, stack=None, inCombo=False, equivalences=None, checked=True, finish='', verbose=False):
		if stack == None: stack=[]
		if equivalences == None: equivalences=[]
		if not checked:
			test_symbol_container = snode.graph.nodes[n2id['container']]
			if not (test_symbol_container.sType == 'object'):
				if verbose: print 'test_symbol_container(',n2id['container'],').sType == object' , test_symbol_container.sType == 'object'
				raise WrongRuleExecution('hierarchicalFindCoffeePotInTable_trigger1')
			test_symbol_robot = snode.graph.nodes[n2id['robot']]
			if not (test_symbol_robot.sType == 'robot' and test_symbol_robot.name!=test_symbol_container.name and [n2id["robot"],n2id["container"],"know"] in snode.graph.links):
				if verbose: print 'test_symbol_robot(',n2id['robot'],').sType == robot' , test_symbol_robot.sType == 'robot'
				raise WrongRuleExecution('hierarchicalFindCoffeePotInTable_trigger2')
			test_symbol_room = snode.graph.nodes[n2id['room']]
			if not (test_symbol_room.sType == 'object' and test_symbol_room.name!=test_symbol_container.name and test_symbol_room.name!=test_symbol_robot.name and [n2id["robot"],n2id["room"],"in"] in snode.graph.links and [n2id["container"],n2id["room"],"in"] in snode.graph.links):
				if verbose: print 'test_symbol_room(',n2id['room'],').sType == object' , test_symbol_room.sType == 'object'
		...
		newNode.nodeId = lastNodeId
		newNode.parentNodeToExplore = copy.deepcopy(snode)
		newNode.parentNodeToExploreWith = self.hierarchicalFindCoffeePotInTable
		newNode.stackP = copy.deepcopy(stack)
		newNode.equivalencesP = copy.deepcopy(equivalences)
		# Create nodes
		if not 'status' in n2id:
		...
		if not inCombo:
			newNode.cost += 1
			newNode.depth += 1
		newNode.history.append('*hierarchicalFindCoffeePotInTable@' + str(n2id) )
		if finish!='': newNode.history.append(finish)
		return newNode
		
		

	def hierarchicalFindCoffeePotInTable_target(self, graph, smapping=dict()):
		n2id = copy.deepcopy(smapping)
						...
						for symbol_status_name in available:
							...
							if symbol_status.sType == 'objectSt' and symbol_status.name!=symbol_container.name and symbol_status.name!=symbol_room.name and symbol_status.name!=symbol_contst.name and symbol_status.name!=symbol_robot.name:
								...
								for symbol_object_name in available:
									...
									if [n2id["object"],n2id["status"],"see"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["status"],"classified"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["status"],"coffeepot"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["status"],"reach"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["status"],"position"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["status"],"reachable"]  in graph.links: linksVal += 100
									if [n2id["object"],n2id["status"],"hasStatus"]  in graph.links: linksVal += 100
									...
									scoreLinks.append(linksVal)
									maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
									if symbol_object.sType == 'object' and symbol_object.name!=symbol_container.name and symbol_object.name!=symbol_room.name and symbol_object.name!=symbol_contst.name and symbol_object.name!=symbol_robot.name and symbol_object.name!=symbol_status.name and [n2id["robot"],n2id["object"],"know"] in graph.links and [n2id["object"],n2id["status"],"see"] in graph.links and [n2id["object"],n2id["status"],"classified"] in graph.links and [n2id["object"],n2id["status"],"coffeepot"] in graph.links and [n2id["object"],n2id["status"],"reach"] in graph.links and [n2id["object"],n2id["status"],"position"] in graph.links and [n2id["object"],n2id["status"],"reachable"] in graph.links and [n2id["object"],n2id["status"],"hasStatus"] in graph.links and [n2id["object"],n2id["container"],"in"] in graph.links:
										scoreNodes.append(100)
										maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
										if maxScore == 2000:
											return maxScore, True
	...
	# Rule hierarchicalFindCoffeePotInTable_noReach
	def hierarchicalFindCoffeePotInTable_noReach(self, snode, stackP=None, equivalencesP=None):
		if stackP == None: stackP=[]
		if equivalencesP == None: equivalencesP=[]
		stack        = copy.deepcopy(stackP)
		equivalences = copy.deepcopy(equivalencesP)
							...
							if symbol_room.sType == 'object' and symbol_room.name!=symbol_container.name and symbol_room.name!=symbol_robot.name and [n2id["robot"],n2id["room"],"in"] in snode.graph.links and [n2id["container"],n2id["room"],"in"] in snode.graph.links:
								for symbol_contst_name in symbol_contst_nodes:
									...
									if symbol_contst.sType == 'objectSt' and symbol_contst.name!=symbol_container.name and symbol_contst.name!=symbol_robot.name and symbol_contst.name!=symbol_room.name and [n2id["container"],n2id["contst"],"table"] in snode.graph.links and not [n2id["container"],n2id["contst"],"explored"] in snode.graph.links:
										...
										stack2        = copy.deepcopy(stack)
										equivalences2 = copy.deepcopy(equivalences)
										r1 = self.hierarchicalFindCoffeePotInTable_noReach_trigger(snode, n2id, stack2, inCombo, equivalences2, copy.deepcopy(finishesCombo))
										c = copy.deepcopy(r1)
										if 'fina' in locals():
											c.history.append(finishesCombo)
										if len(stack2) > 0: c.stop = True
	...
	# Rule hierarchicalFindCoffeePotInTable_noReach
	def hierarchicalFindCoffeePotInTable_noReach_trigger(self, snode, n2id, stack=None, inCombo=False, equivalences=None, checked=True, finish='', verbose=False):
		if stack == None: stack=[]
		if equivalences == None: equivalences=[]
		if not checked:
			test_symbol_container = snode.graph.nodes[n2id['container']]
			if not (test_symbol_container.sType == 'object'):
				if verbose: print 'test_symbol_container(',n2id['container'],').sType == object' , test_symbol_container.sType == 'object'
				raise WrongRuleExecution('hierarchicalFindCoffeePotInTable_noReach_trigger1')
			test_symbol_robot = snode.graph.nodes[n2id['robot']]
			if not (test_symbol_robot.sType == 'robot' and test_symbol_robot.name!=test_symbol_container.name and [n2id["robot"],n2id["container"],"know"] in snode.graph.links):
				if verbose: print 'test_symbol_robot(',n2id['robot'],').sType == robot' , test_symbol_robot.sType == 'robot'
				raise WrongRuleExecution('hierarchicalFindCoffeePotInTable_noReach_trigger2')
			test_symbol_room = snode.graph.nodes[n2id['room']]
			if not (test_symbol_room.sType == 'object' and test_symbol_room.name!=test_symbol_container.name and test_symbol_room.name!=test_symbol_robot.name and [n2id["robot"],n2id["room"],"in"] in snode.graph.links and [n2id["container"],n2id["room"],"in"] in snode.graph.links):
				if verbose: print 'test_symbol_room(',n2id['room'],').sType == object' , test_symbol_room.sType == 'object'
		...
		newNode.nodeId = lastNodeId
		newNode.parentNodeToExplore = copy.deepcopy(snode)
		newNode.parentNodeToExploreWith = self.hierarchicalFindCoffeePotInTable_noReach
		newNode.stackP = copy.deepcopy(stack)
		newNode.equivalencesP = copy.deepcopy(equivalences)
		# Create nodes
		if not 'status' in n2id:
		...
		if not inCombo:
			newNode.cost += 1
			newNode.depth += 1
		newNode.history.append('*hierarchicalFindCoffeePotInTable_noReach@' + str(n2id) )
		if finish!='': newNode.history.append(finish)
		return newNode
		
		

	def hierarchicalFindCoffeePotInTable_noReach_target(self, graph, smapping=dict()):
		n2id = copy.deepcopy(smapping)
	...
	# Rule robotMovesObjectFromContainer
	def robotMovesObjectFromContainer(self, snode, stackP=None, equivalencesP=None):
		if stackP == None: stackP=[]
		if equivalencesP == None: equivalencesP=[]
		stack        = copy.deepcopy(stackP)
		equivalences = copy.deepcopy(equivalencesP)
		...
		if len(stack) > 0:
			...
			# Find equivalence for os
			symbol_os_nodes = symbol_nodes_copy
			for equiv in equivalences:
				if [me, 'os'] in equiv[0] and equiv[1] != None:
					symbol_os_nodes = [equiv[1]]
		else:
			inCombo = False
			symbol_roomst_nodes = symbol_nodes_copy
			symbol_room_nodes = symbol_nodes_copy
		...
		for symbol_robot_name in symbol_robot_nodes:
			...
			if symbol_robot.sType == 'robot':
				for symbol_room_name in symbol_room_nodes:
					symbol_room = nodes[symbol_room_name]
					n2id['room'] = symbol_room_name
					if symbol_room.sType == 'object' and symbol_room.name!=symbol_robot.name and [n2id["robot"],n2id["room"],"in"] in snode.graph.links:
						for symbol_object_name in symbol_object_nodes:
							symbol_object = nodes[symbol_object_name]
							n2id['object'] = symbol_object_name
							if symbol_object.sType == 'object' and symbol_object.name!=symbol_robot.name and symbol_object.name!=symbol_room.name and [n2id["robot"],n2id["object"],"know"] in snode.graph.links:
								for symbol_c1_name in symbol_c1_nodes:
									symbol_c1 = nodes[symbol_c1_name]
									n2id['c1'] = symbol_c1_name
									if symbol_c1.sType == 'object' and symbol_c1.name!=symbol_robot.name and symbol_c1.name!=symbol_room.name and symbol_c1.name!=symbol_object.name and [n2id["robot"],n2id["c1"],"know"] in snode.graph.links and [n2id["object"],n2id["c1"],"in"] in snode.graph.links and [n2id["object"],n2id["c1"],"reach"] in snode.graph.links and [n2id["c1"],n2id["room"],"in"] in snode.graph.links:
										for symbol_c2_name in symbol_c2_nodes:
											symbol_c2 = nodes[symbol_c2_name]
											n2id['c2'] = symbol_c2_name
											if symbol_c2.sType == 'object' and symbol_c2.name!=symbol_robot.name and symbol_c2.name!=symbol_room.name and symbol_c2.name!=symbol_object.name and symbol_c2.name!=symbol_c1.name and [n2id["robot"],n2id["c2"],"know"] in snode.graph.links and [n2id["c2"],n2id["room"],"in"] in snode.graph.links:
												for symbol_roomst_name in symbol_roomst_nodes:
													symbol_roomst = nodes[symbol_roomst_name]
													n2id['roomst'] = symbol_roomst_name
													if symbol_roomst.sType == 'roomSt' and symbol_roomst.name!=symbol_robot.name and symbol_roomst.name!=symbol_room.name and symbol_roomst.name!=symbol_object.name and symbol_roomst.name!=symbol_c1.name and symbol_roomst.name!=symbol_c2.name and [n2id["room"],n2id["roomst"],"room"] in snode.graph.links:
														for symbol_os_name in symbol_os_nodes:
															symbol_os = nodes[symbol_os_name]
															n2id['os'] = symbol_os_name
															if symbol_os.sType == 'objectSt' and symbol_os.name!=symbol_robot.name and symbol_os.name!=symbol_room.name and symbol_os.name!=symbol_object.name and symbol_os.name!=symbol_c1.name and symbol_os.name!=symbol_c2.name and symbol_os.name!=symbol_roomst.name:
																# At this point we meet all the conditions.
																stack2        = copy.deepcopy(stack)
																equivalences2 = copy.deepcopy(equivalences)
																r1 = self.robotMovesObjectFromContainer_trigger(snode, n2id, stack2, inCombo, equivalences2, copy.deepcopy(finishesCombo))
																c = copy.deepcopy(r1)
																if 'fina' in locals():
																	c.history.append(finishesCombo)
																if len(stack2) > 0: c.stop = True
	...
	# Rule robotMovesObjectFromContainer
	def robotMovesObjectFromContainer_trigger(self, snode, n2id, stack=None, inCombo=False, equivalences=None, checked=True, finish='', verbose=False):
		if stack == None: stack=[]
		if equivalences == None: equivalences=[]
		if not checked:
			test_symbol_robot = snode.graph.nodes[n2id['robot']]
			if not (test_symbol_robot.sType == 'robot'):
				if verbose: print 'test_symbol_robot(',n2id['robot'],').sType == robot' , test_symbol_robot.sType == 'robot'
				raise WrongRuleExecution('robotMovesObjectFromContainer_trigger1')
			test_symbol_room = snode.graph.nodes[n2id['room']]
			if not (test_symbol_room.sType == 'object' and test_symbol_room.name!=test_symbol_robot.name and [n2id["robot"],n2id["room"],"in"] in snode.graph.links):
				if verbose: print 'test_symbol_room(',n2id['room'],').sType == object' , test_symbol_room.sType == 'object'
				raise WrongRuleExecution('robotMovesObjectFromContainer_trigger2')
			test_symbol_object = snode.graph.nodes[n2id['object']]
			if not (test_symbol_object.sType == 'object' and test_symbol_object.name!=test_symbol_robot.name and test_symbol_object.name!=test_symbol_room.name and [n2id["robot"],n2id["object"],"know"] in snode.graph.links):
				if verbose: print 'test_symbol_object(',n2id['object'],').sType == object' , test_symbol_object.sType == 'object'
				raise WrongRuleExecution('robotMovesObjectFromContainer_trigger3')
			test_symbol_c1 = snode.graph.nodes[n2id['c1']]
			if not (test_symbol_c1.sType == 'object' and test_symbol_c1.name!=test_symbol_robot.name and test_symbol_c1.name!=test_symbol_room.name and test_symbol_c1.name!=test_symbol_object.name and [n2id["robot"],n2id["c1"],"know"] in snode.graph.links and [n2id["object"],n2id["c1"],"in"] in snode.graph.links and [n2id["object"],n2id["c1"],"reach"] in snode.graph.links and [n2id["c1"],n2id["room"],"in"] in snode.graph.links):
				if verbose: print 'test_symbol_c1(',n2id['c1'],').sType == object' , test_symbol_c1.sType == 'object'
				raise WrongRuleExecution('robotMovesObjectFromContainer_trigger4')
			test_symbol_c2 = snode.graph.nodes[n2id['c2']]
			if not (test_symbol_c2.sType == 'object' and test_symbol_c2.name!=test_symbol_robot.name and test_symbol_c2.name!=test_symbol_room.name and test_symbol_c2.name!=test_symbol_object.name and test_symbol_c2.name!=test_symbol_c1.name and [n2id["robot"],n2id["c2"],"know"] in snode.graph.links and [n2id["c2"],n2id["room"],"in"] in snode.graph.links):
				if verbose: print 'test_symbol_c2(',n2id['c2'],').sType == object' , test_symbol_c2.sType == 'object'
				raise WrongRuleExecution('robotMovesObjectFromContainer_trigger5')
			test_symbol_roomst = snode.graph.nodes[n2id['roomst']]
			if not (test_symbol_roomst.sType == 'roomSt' and test_symbol_roomst.name!=test_symbol_robot.name and test_symbol_roomst.name!=test_symbol_room.name and test_symbol_roomst.name!=test_symbol_object.name and test_symbol_roomst.name!=test_symbol_c1.name and test_symbol_roomst.name!=test_symbol_c2.name and [n2id["room"],n2id["roomst"],"room"] in snode.graph.links):
				if verbose: print 'test_symbol_roomst(',n2id['roomst'],').sType == roomSt' , test_symbol_roomst.sType == 'roomSt'
				raise WrongRuleExecution('robotMovesObjectFromContainer_trigger6')
			test_symbol_os = snode.graph.nodes[n2id['os']]
			if not (test_symbol_os.sType == 'objectSt' and test_symbol_os.name!=test_symbol_robot.name and test_symbol_os.name!=test_symbol_room.name and test_symbol_os.name!=test_symbol_object.name and test_symbol_os.name!=test_symbol_c1.name and test_symbol_os.name!=test_symbol_c2.name and test_symbol_os.name!=test_symbol_roomst.name):
				if verbose: print 'test_symbol_os(',n2id['os'],').sType == objectSt' , test_symbol_os.sType == 'objectSt'
				raise WrongRuleExecution('robotMovesObjectFromContainer_trigger7')
		newNode = WorldStateHistory(snode)
		global lastNodeId
		lastNodeId += 1
		newNode.nodeId = lastNodeId
		newNode.parentNodeToExplore = copy.deepcopy(snode)
		newNode.parentNodeToExploreWith = self.robotMovesObjectFromContainer
		newNode.stackP = copy.deepcopy(stack)
		newNode.equivalencesP = copy.deepcopy(equivalences)
		# Create nodes
		# Retype nodes
		# Remove nodes
		# Remove links
		newNode.graph.links = [x for x in newNode.graph.links if [x.a, x.b, x.linkType] not in [ [n2id['object'], n2id['c1'], 'in'] ]]
		# Create links
		l = AGMLink(n2id['object'], n2id['c2'], 'in')
		if not l in newNode.graph.links:
			newNode.graph.links.append(l)
		l = AGMLink(n2id['object'], n2id['c2'], 'reach')
		if not l in newNode.graph.links:
			newNode.graph.links.append(l)
		l = AGMLink(n2id['object'], n2id['os'], 'reach')
		if not l in newNode.graph.links:
			newNode.graph.links.append(l)
		# Misc stuff
		if not inCombo:
			newNode.cost += 1
			newNode.depth += 1
		newNode.history.append('*robotMovesObjectFromContainer@' + str(n2id) )
		if finish!='': newNode.history.append(finish)
		return newNode
		
		

	def robotMovesObjectFromContainer_target(self, graph, smapping=dict()):
		n2id = copy.deepcopy(smapping)
		...
		del available[n2id['roomst']]
		del available[n2id['room']]
		del available[n2id['object']]
		del available[n2id['robot']]
		del available[n2id['c2']]
		del available[n2id['c1']]
		del available[n2id['os']]
		# Hard score
		scoreNodes = []
		scoreLinks = []
		# roomst
		symbol_roomst = graph.nodes[n2id['roomst']]
		linksVal = 0
		scoreLinks.append(linksVal)
		maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
		if symbol_roomst.sType == 'roomSt':
			scoreNodes.append(100)
			maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
			# room
			symbol_room = graph.nodes[n2id['room']]
			linksVal = 0
			if [n2id["room"],n2id["roomst"],"room"]  in graph.links: linksVal += 100
			scoreLinks.append(linksVal)
			maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
			if symbol_room.sType == 'object' and symbol_room.name!=symbol_roomst.name and [n2id["room"],n2id["roomst"],"room"] in graph.links:
				scoreNodes.append(100)
				maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
				# object
				symbol_object = graph.nodes[n2id['object']]
				linksVal = 0
				scoreLinks.append(linksVal)
				maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
				if symbol_object.sType == 'object' and symbol_object.name!=symbol_roomst.name and symbol_object.name!=symbol_room.name:
					scoreNodes.append(100)
					maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
					# robot
					symbol_robot = graph.nodes[n2id['robot']]
					...
					scoreLinks.append(linksVal)
					maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
					if symbol_robot.sType == 'robot' and symbol_robot.name!=symbol_roomst.name and symbol_robot.name!=symbol_room.name and symbol_robot.name!=symbol_object.name and [n2id["robot"],n2id["object"],"know"] in graph.links and [n2id["robot"],n2id["room"],"in"] in graph.links:
						scoreNodes.append(100)
						maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
						# c2
						symbol_c2 = graph.nodes[n2id['c2']]
						linksVal = 0
						if [n2id["robot"],n2id["c2"],"know"]  in graph.links: linksVal += 100
						if [n2id["object"],n2id["c2"],"in"]  in graph.links: linksVal += 100
						if [n2id["object"],n2id["c2"],"reach"]  in graph.links: linksVal += 100
						if [n2id["c2"],n2id["room"],"in"]  in graph.links: linksVal += 100
						scoreLinks.append(linksVal)
						maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
						if symbol_c2.sType == 'object' and symbol_c2.name!=symbol_roomst.name and symbol_c2.name!=symbol_room.name and symbol_c2.name!=symbol_object.name and symbol_c2.name!=symbol_robot.name and [n2id["robot"],n2id["c2"],"know"] in graph.links and [n2id["object"],n2id["c2"],"in"] in graph.links and [n2id["object"],n2id["c2"],"reach"] in graph.links and [n2id["c2"],n2id["room"],"in"] in graph.links:
							scoreNodes.append(100)
							maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
							# c1
							symbol_c1 = graph.nodes[n2id['c1']]
							linksVal = 0
							if [n2id["robot"],n2id["c1"],"know"]  in graph.links: linksVal += 100
							if [n2id["object"],n2id["c1"],"reach"]  in graph.links: linksVal += 100
							if [n2id["c1"],n2id["room"],"in"]  in graph.links: linksVal += 100
							scoreLinks.append(linksVal)
							maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
							if symbol_c1.sType == 'object' and symbol_c1.name!=symbol_roomst.name and symbol_c1.name!=symbol_room.name and symbol_c1.name!=symbol_object.name and symbol_c1.name!=symbol_robot.name and symbol_c1.name!=symbol_c2.name and [n2id["robot"],n2id["c1"],"know"] in graph.links and [n2id["object"],n2id["c1"],"reach"] in graph.links and [n2id["c1"],n2id["room"],"in"] in graph.links:
								scoreNodes.append(100)
								maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
								# os
								symbol_os = graph.nodes[n2id['os']]
								linksVal = 0
								if [n2id["object"],n2id["os"],"reach"]  in graph.links: linksVal += 100
								scoreLinks.append(linksVal)
								maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
								if symbol_os.sType == 'objectSt' and symbol_os.name!=symbol_roomst.name and symbol_os.name!=symbol_room.name and symbol_os.name!=symbol_object.name and symbol_os.name!=symbol_robot.name and symbol_os.name!=symbol_c2.name and symbol_os.name!=symbol_c1.name and [n2id["object"],n2id["os"],"reach"] in graph.links:
									scoreNodes.append(100)
									maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
									if maxScore == 1800:
										return maxScore, True
	...
	# Rule robotDeliversObject
	def robotDeliversObject(self, snode, stackP=None, equivalencesP=None):
		if stackP == None: stackP=[]
		if equivalencesP == None: equivalencesP=[]
		stack        = copy.deepcopy(stackP)
		equivalences = copy.deepcopy(equivalencesP)
		...
		for symbol_room_name in symbol_room_nodes:
			...
			if symbol_room.sType == 'object':
				for symbol_robot_name in symbol_robot_nodes:
					symbol_robot = nodes[symbol_robot_name]
					n2id['robot'] = symbol_robot_name
					if symbol_robot.sType == 'robot' and symbol_robot.name!=symbol_room.name:
						for symbol_person_name in symbol_person_nodes:
							symbol_person = nodes[symbol_person_name]
							n2id['person'] = symbol_person_name
							if symbol_person.sType == 'person' and symbol_person.name!=symbol_room.name and symbol_person.name!=symbol_robot.name and [n2id["person"],n2id["room"],"in"] in snode.graph.links:
								for symbol_roomst_name in symbol_roomst_nodes:
									symbol_roomst = nodes[symbol_roomst_name]
									n2id['roomst'] = symbol_roomst_name
									if symbol_roomst.sType == 'roomSt' and symbol_roomst.name!=symbol_room.name and symbol_roomst.name!=symbol_robot.name and symbol_roomst.name!=symbol_person.name and [n2id["room"],n2id["roomst"],"room"] in snode.graph.links:
										for symbol_object_name in symbol_object_nodes:
											symbol_object = nodes[symbol_object_name]
											n2id['object'] = symbol_object_name
											if symbol_object.sType == 'object' and symbol_object.name!=symbol_room.name and symbol_object.name!=symbol_robot.name and symbol_object.name!=symbol_person.name and symbol_object.name!=symbol_roomst.name and [n2id["robot"],n2id["object"],"know"] in snode.graph.links:
												# At this point we meet all the conditions.
												stack2        = copy.deepcopy(stack)
												equivalences2 = copy.deepcopy(equivalences)
												r1 = self.robotDeliversObject_trigger(snode, n2id, stack2, inCombo, equivalences2, copy.deepcopy(finishesCombo))
												c = copy.deepcopy(r1)
												if 'fina' in locals():
													c.history.append(finishesCombo)
												if len(stack2) > 0: c.stop = True
	...
	# Rule robotDeliversObject
	def robotDeliversObject_trigger(self, snode, n2id, stack=None, inCombo=False, equivalences=None, checked=True, finish='', verbose=False):
		if stack == None: stack=[]
		if equivalences == None: equivalences=[]
		if not checked:
			test_symbol_room = snode.graph.nodes[n2id['room']]
			if not (test_symbol_room.sType == 'object'):
				if verbose: print 'test_symbol_room(',n2id['room'],').sType == object' , test_symbol_room.sType == 'object'
				raise WrongRuleExecution('robotDeliversObject_trigger1')
			test_symbol_robot = snode.graph.nodes[n2id['robot']]
			if not (test_symbol_robot.sType == 'robot' and test_symbol_robot.name!=test_symbol_room.name):
				if verbose: print 'test_symbol_robot(',n2id['robot'],').sType == robot' , test_symbol_robot.sType == 'robot'
				raise WrongRuleExecution('robotDeliversObject_trigger2')
			test_symbol_person = snode.graph.nodes[n2id['person']]
			if not (test_symbol_person.sType == 'person' and test_symbol_person.name!=test_symbol_room.name and test_symbol_person.name!=test_symbol_robot.name and [n2id["person"],n2id["room"],"in"] in snode.graph.links):
				if verbose: print 'test_symbol_person(',n2id['person'],').sType == person' , test_symbol_person.sType == 'person'
				raise WrongRuleExecution('robotDeliversObject_trigger3')
			test_symbol_roomst = snode.graph.nodes[n2id['roomst']]
			if not (test_symbol_roomst.sType == 'roomSt' and test_symbol_roomst.name!=test_symbol_room.name and test_symbol_roomst.name!=test_symbol_robot.name and test_symbol_roomst.name!=test_symbol_person.name and [n2id["room"],n2id["roomst"],"room"] in snode.graph.links):
				if verbose: print 'test_symbol_roomst(',n2id['roomst'],').sType == roomSt' , test_symbol_roomst.sType == 'roomSt'
				raise WrongRuleExecution('robotDeliversObject_trigger4')
			test_symbol_object = snode.graph.nodes[n2id['object']]
			if not (test_symbol_object.sType == 'object' and test_symbol_object.name!=test_symbol_room.name and test_symbol_object.name!=test_symbol_robot.name and test_symbol_object.name!=test_symbol_person.name and test_symbol_object.name!=test_symbol_roomst.name and [n2id["robot"],n2id["object"],"know"] in snode.graph.links):
				if verbose: print 'test_symbol_object(',n2id['object'],').sType == object' , test_symbol_object.sType == 'object'
				raise WrongRuleExecution('robotDeliversObject_trigger5')
		newNode = WorldStateHistory(snode)
		global lastNodeId
		lastNodeId += 1
		newNode.nodeId = lastNodeId
		newNode.parentNodeToExplore = copy.deepcopy(snode)
		newNode.parentNodeToExploreWith = self.robotDeliversObject
		newNode.stackP = copy.deepcopy(stack)
		newNode.equivalencesP = copy.deepcopy(equivalences)
		# Create nodes
		# Retype nodes
		...
		if not l in newNode.graph.links:
			newNode.graph.links.append(l)
		l = AGMLink(n2id['robot'], n2id['room'], 'in')
		if not l in newNode.graph.links:
			newNode.graph.links.append(l)
		# Textual effects
		nodes = copy.deepcopy(newNode.graph.nodes)
		backVars = n2id.keys()
		for symbol_previousroom_name in nodes:
			symbol_previousroom = nodes[symbol_previousroom_name]
			n2id['previousroom'] = symbol_previousroom_name
			if symbol_previousroom.sType == 'object':  # now the body of the FORALL
				condition3 = True # AND initialization as true
				condition5 = (n2id["previousroom"] == n2id["room"])
				condition4 = not condition5
				if condition4 == False: # if what's inside the AND is false
					condition3 = False # make the AND false
				if condition3: # if still true
					condition6 = [n2id["previousroom"],n2id["robot"],"in"] in snode.graph.links # LINK
					if condition6 == False: # if what's inside the AND is false
						condition3 = False # make the AND false
					if condition3 == True: # if what's inside the WHEN(if) is True
						if [n2id["previousroom"], n2id["robot"], "in"] in newNode.graph.links:
							newNode.graph.links = [x for x in newNode.graph.links if x.a!=n2id["previousroom"] or x.b!=n2id["robot"] or x.linkType!="in"]
		for symbol_previouscontainer_name in nodes:
			symbol_previouscontainer = nodes[symbol_previouscontainer_name]
			n2id['previouscontainer'] = symbol_previouscontainer_name
			if symbol_previouscontainer.sType == 'object':  # now the body of the FORALL
				condition11 = True # AND initialization as true
				condition13 = (n2id["previouscontainer"] == n2id["person"])
				condition12 = not condition13
				if condition12 == False: # if what's inside the AND is false
					condition11 = False # make the AND false
				if condition11: # if still true
					condition14 = [n2id["previouscontainer"],n2id["object"],"in"] in snode.graph.links # LINK
					if condition14 == False: # if what's inside the AND is false
						condition11 = False # make the AND false
					if condition11 == True: # if what's inside the WHEN(if) is True
						if [n2id["previouscontainer"], n2id["object"], "in"] in newNode.graph.links:
							newNode.graph.links = [x for x in newNode.graph.links if x.a!=n2id["previouscontainer"] or x.b!=n2id["object"] or x.linkType!="in"]
		for k in n2id.keys():
			if not k in backVars:
				del n2id[k]
		# Misc stuff
		if not inCombo:
			newNode.cost += 1
			newNode.depth += 1
		newNode.history.append('*robotDeliversObject@' + str(n2id) )
		if finish!='': newNode.history.append(finish)
		return newNode
		
		

	def robotDeliversObject_target(self, graph, smapping=dict()):
		n2id = copy.deepcopy(smapping)
		...
		scoreLinks = []
		# person
		symbol_person = graph.nodes[n2id['person']]
		linksVal = 0
		scoreLinks.append(linksVal)
		maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
		if symbol_person.sType == 'person':
			scoreNodes.append(100)
			maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
			# roomst
			symbol_roomst = graph.nodes[n2id['roomst']]
			...
			scoreLinks.append(linksVal)
			maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
			if symbol_roomst.sType == 'roomSt' and symbol_roomst.name!=symbol_person.name:
				scoreNodes.append(100)
				maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
				# object
				symbol_object = graph.nodes[n2id['object']]
				linksVal = 0
				if [n2id["object"],n2id["person"],"in"]  in graph.links: linksVal += 100
				scoreLinks.append(linksVal)
				maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
				if symbol_object.sType == 'object' and symbol_object.name!=symbol_person.name and symbol_object.name!=symbol_roomst.name and [n2id["object"],n2id["person"],"in"] in graph.links:
					scoreNodes.append(100)
					maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
					# room
					symbol_room = graph.nodes[n2id['room']]
					linksVal = 0
					if [n2id["room"],n2id["roomst"],"room"]  in graph.links: linksVal += 100
					if [n2id["person"],n2id["room"],"in"]  in graph.links: linksVal += 100
					scoreLinks.append(linksVal)
					maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
					if symbol_room.sType == 'object' and symbol_room.name!=symbol_person.name and symbol_room.name!=symbol_roomst.name and symbol_room.name!=symbol_object.name and [n2id["room"],n2id["roomst"],"room"] in graph.links and [n2id["person"],n2id["room"],"in"] in graph.links:
						scoreNodes.append(100)
						maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
						# robot
						symbol_robot = graph.nodes[n2id['robot']]
						...
						scoreLinks.append(linksVal)
						maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
						if symbol_robot.sType == 'robot' and symbol_robot.name!=symbol_person.name and symbol_robot.name!=symbol_roomst.name and symbol_robot.name!=symbol_object.name and symbol_robot.name!=symbol_room.name and [n2id["robot"],n2id["object"],"know"] in graph.links and [n2id["robot"],n2id["room"],"in"] in graph.links:
							scoreNodes.append(100)
							maxScore = computeMaxScore(scoreNodes, scoreLinks, maxScore)
							if maxScore == 1000:
								return maxScore, True
