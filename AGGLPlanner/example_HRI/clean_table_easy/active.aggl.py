...
class RuleSet(object):
	...
	def getRules(self):
		...
		mapping['moveMugFromTableToBox'] = self.moveMugFromTableToBox
		return mapping
	...
	def getTriggers(self):
		...
		mapping['moveMugFromTableToBox'] = self.moveMugFromTableToBox_trigger
		return mapping
	...
	# Rule findObjectVisually
	def findObjectVisually_trigger(self, snode, n2id):
		ret = []
	...
	# Rule findObjectTold
	def findObjectTold_trigger(self, snode, n2id):
		ret = []
		smap = copy.deepcopy(n2id)
		newNode = WorldStateHistory(snode)
		# Create nodes
	...
	# Rule recognizeObjMug
	def recognizeObjMug_trigger(self, snode, n2id):
		ret = []
		smap = copy.deepcopy(n2id)
		newNode = WorldStateHistory(snode)
		# Create nodes
	...
	# Rule recognizeObjBox
	def recognizeObjBox_trigger(self, snode, n2id):
		ret = []
		smap = copy.deepcopy(n2id)
		newNode = WorldStateHistory(snode)
		# Create nodes
	...
	# Rule recognizeObjTable
	def recognizeObjTable_trigger(self, snode, n2id):
		ret = []
		smap = copy.deepcopy(n2id)
		newNode = WorldStateHistory(snode)
		# Create nodes
	...
	# Rule recognizeObjFails
	def recognizeObjFails_trigger(self, snode, n2id):
		ret = []
		smap = copy.deepcopy(n2id)
		newNode = WorldStateHistory(snode)
		# Create nodes
	...
	# Rule setObjectReach
	def setObjectReach_trigger(self, snode, n2id):
		ret = []
		smap = copy.deepcopy(n2id)
		newNode = WorldStateHistory(snode)
		# Create nodes
	...
	# Rule setObjectSee
	def setObjectSee_trigger(self, snode, n2id):
		ret = []
		smap = copy.deepcopy(n2id)
		newNode = WorldStateHistory(snode)
		# Create nodes
	...
	# Rule setObjectPosition
	def setObjectPosition_trigger(self, snode, n2id):
		ret = []
		smap = copy.deepcopy(n2id)
		newNode = WorldStateHistory(snode)
		# Create nodes
	...
	# Rule tellHumanAboutMug
	def tellHumanAboutMug_trigger(self, snode, n2id):
		ret = []
		smap = copy.deepcopy(n2id)
		newNode = WorldStateHistory(snode)
		# Create nodes
	...
	# Rule tellHumanAboutBox
	def tellHumanAboutBox_trigger(self, snode, n2id):
		ret = []
		smap = copy.deepcopy(n2id)
		newNode = WorldStateHistory(snode)
		# Create nodes
	...
	# Rule tellHumanAboutTable
	def tellHumanAboutTable_trigger(self, snode, n2id):
		ret = []
		smap = copy.deepcopy(n2id)
		newNode = WorldStateHistory(snode)
		# Create nodes
	...
	# Rule tellHumanAboutUnknownObject
	def tellHumanAboutUnknownObject_trigger(self, snode, n2id):
		ret = []
		smap = copy.deepcopy(n2id)
		newNode = WorldStateHistory(snode)
		# Create nodes
	...
	# Rule makeHumanLook
	def makeHumanLook_trigger(self, snode, n2id):
		ret = []
		smap = copy.deepcopy(n2id)
		newNode = WorldStateHistory(snode)
		# Create nodes
	...
	# Rule humanClassifiesMug
	def humanClassifiesMug_trigger(self, snode, n2id):
		ret = []
		smap = copy.deepcopy(n2id)
		newNode = WorldStateHistory(snode)
		# Create nodes
	...
	# Rule humanClassifiesBox
	def humanClassifiesBox_trigger(self, snode, n2id):
		ret = []
		smap = copy.deepcopy(n2id)
		newNode = WorldStateHistory(snode)
		# Create nodes
	...
	# Rule humanClassifiesTable
	def humanClassifiesTable_trigger(self, snode, n2id):
		ret = []
		smap = copy.deepcopy(n2id)
		newNode = WorldStateHistory(snode)
		# Create nodes
	...
	# Rule humanTellsUsAboutMug
	def humanTellsUsAboutMug_trigger(self, snode, n2id):
		ret = []
		smap = copy.deepcopy(n2id)
		newNode = WorldStateHistory(snode)
		# Create nodes
	...
	# Rule humanTellsUsAboutBox
	def humanTellsUsAboutBox_trigger(self, snode, n2id):
		ret = []
		smap = copy.deepcopy(n2id)
		newNode = WorldStateHistory(snode)
		# Create nodes
	...
	# Rule humanTellsUsAboutTable
	def humanTellsUsAboutTable_trigger(self, snode, n2id):
		ret = []
		smap = copy.deepcopy(n2id)
		newNode = WorldStateHistory(snode)
		# Create nodes
	...
	# Rule moveMugFromTableToBox
	def moveMugFromTableToBox(self, snode):
		ret = []
		nodes = copy.deepcopy(snode.graph.nodes)
		n2id = dict()
																									...
																									if symbol_m.sType == 'mug' and symbol_m.name!=symbol_s.name and symbol_m.name!=symbol_r.name and symbol_m.name!=symbol_cs2.name and symbol_m.name!=symbol_cs1.name and symbol_m.name!=symbol_c1.name and symbol_m.name!=symbol_o.name and symbol_m.name!=symbol_c2.name and symbol_m.name!=symbol_t.name and symbol_m.name!=symbol_rc2.name and symbol_m.name!=symbol_rc1.name and symbol_m.name!=symbol_r1.name and [n2id["s"],n2id["m"],"link"] in snode.graph.links:
																										for symbol_b_name in nodes:
																											...
																											if symbol_b.sType == 'box' and symbol_b.name!=symbol_s.name and symbol_b.name!=symbol_r.name and symbol_b.name!=symbol_cs2.name and symbol_b.name!=symbol_cs1.name and symbol_b.name!=symbol_c1.name and symbol_b.name!=symbol_o.name and symbol_b.name!=symbol_c2.name and symbol_b.name!=symbol_t.name and symbol_b.name!=symbol_rc2.name and symbol_b.name!=symbol_rc1.name and symbol_b.name!=symbol_r1.name and symbol_b.name!=symbol_m.name and [n2id["cs2"],n2id["b"],"link"] in snode.graph.links:
																												...
																												# Insert additional conditions manually here if you want.
																												# (beware that the code could be regenerated and you might lose your changes).
																												ret.append(self.moveMugFromTableToBox_trigger(snode, n2id))
		return ret
		
		

	# Rule moveMugFromTableToBox
	def moveMugFromTableToBox_trigger(self, snode, n2id):
		ret = []
		smap = copy.deepcopy(n2id)
		newNode = WorldStateHistory(snode)
		# Create nodes
		...
		newNode.cost += 3
		newNode.depth += 1
		newNode.history.append('moveMugFromTableToBox@' + str(n2id) )
		return newNode
